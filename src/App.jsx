...
function getClientStatus(hourly) {
  ...
  if (hourly >= 10000) return { label: "Frábært", emoji: "🟢", bg: "#dcfce7", color: "#166534" };
  if (hourly >= 7000)  return { label: "Gott",    emoji: "🔵", bg: "#dbeafe", color: "#1d4ed8" };
  if (hourly >= 4500)  return { label: "Í lagi",  emoji: "🟡", bg: "#fef3c7", color: "#92400e" };
