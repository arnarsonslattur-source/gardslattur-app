...
export default function App() {
  ...
  // alltaf í dag þegar farið í Skrá
  useEffect(() => {
    if (screen === "Skrá") {
      setEntry((prev) => ({
        ...prev,
  ...
  const todayLogs = logs.filter((l) => l.date === getTodayLocal());
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
        <button onClick={() => setScreen("Skrá")}>Skrá</button>
        <button onClick={() => setScreen("Í dag")}>Í dag</button>
      </div>
      ...
      {screen === "Skrá" && (
        <div>
          ...
          <input
            ...
            value={entry.earned}
            onChange={(e) =>
              setEntry({ ...entry, earned: e.target.value })
            }
          />

          <button onClick={addLog}>Vista</button>
        </div>
      )}
...
const STORAGE_KEY = "gardslattur-part2-logs";
const DAY_HISTORY_KEY = "gardslattur-part2-day-history";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gap: 16 }}>
        <div>
          <div style={{ fontSize: 32, fontWeight: 900 }}>Garðsláttur</div>
          <div style={{ color: "#64748b", marginTop: 4 }}>Part 2 af 5</div>
        </div>
          ...
          <div style={{ display: "grid", gap: 16 }}>
            <div style={cardStyle()}>
              ...
              <div style={{ color: "#64748b", marginTop: 4 }}>
                Dagsetningin defaultar á daginn í dag
              </div>
              ...
              >
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 14 }}>
                  {!dayTimerState.running && !dayTimerState.dayStartedAt && (
                    <button style={buttonStyle(true)} onClick={startDay}>
                      Byrja dag
                    </button>
                  )}
                  ...
                  {dayTimerState.running && (
                    <>
                      <button style={buttonStyle(false)} onClick={() => addPause(30)}>
                        +30 mín pásu
                      </button>
                      <button style={buttonStyle(true)} onClick={finishDay}>
                        Klára dag
                      </button>
                    </>
                  )}
            ...
            <div style={cardStyle()}>
              ...
              >
                <div>
                  ...
                  <div style={{ color: "#64748b", marginTop: 4 }}>Smelltu á dag</div>
                </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 6, marginTop: 14 }}>
                {WEEK_DAYS.map((day) => (
                  <div
                    key={day}
                    style={{ textAlign: "center", fontWeight: 800, color: "#64748b", padding: "6px 0" }}
                  >
                    {day}
                  </div>
                ))}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 6, marginTop: 6 }}>
                {monthCells.map((cell, i) => {
                  if (!cell) {
                    return <div key={i} style={{ minHeight: 90, borderRadius: 16, background: "#e2e8f0" }} />;
                  }
                  ...
                  return (
                    <button
                      ...
                      style={{
                        minHeight: 90,
                        borderRadius: 16,
                        border: selectedDate === cell.dateStr ? "2px solid #2563eb" : "1px solid #dbe2ea",
                        background:
                          dayLogs.length > 0 ? "#dbeafe" : hasTimer ? "#fef3c7" : "#fff",
                        textAlign: "left",
                        padding: 10,
                        cursor: "pointer",
                      }}
              ...
              <div style={{ display: "grid", gap: 10, marginTop: 14 }}>
                ...
                {selectedDateLogs.map((log) => (
                  <div key={log.id} style={{ background: "#f8fafc", borderRadius: 16, padding: 12 }}>
                    ...
                    <div style={{ marginTop: 6 }}>{log.note}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {screen === "Tölur" && (
          <div style={{ display: "grid", gap: 16 }}>
            <div style={cardStyle()}>
              ...
              <div style={{ color: "#64748b", marginTop: 4 }}>Basic monthly stats</div>
              ...
              >
                <div style={{ background: "#f8fafc", borderRadius: 16, padding: 12 }}>
                  <div style={{ color: "#64748b", fontSize: 13 }}>Tekjur í mánuði</div>
                  <div style={{ fontSize: 24, fontWeight: 900, marginTop: 6 }}>{kr(monthEarned)}</div>
                </div>

                <div style={{ background: "#f8fafc", borderRadius: 16, padding: 12 }}>
                  <div style={{ color: "#64748b", fontSize: 13 }}>Skráður tími</div>
                  <div style={{ fontSize: 24, fontWeight: 900, marginTop: 6 }}>{minsToText(monthMinutes)}</div>
                </div>

                <div style={{ background: "#f8fafc", borderRadius: 16, padding: 12 }}>
                  <div style={{ color: "#64748b", fontSize: 13 }}>Fjöldi verka</div>
                  <div style={{ fontSize: 24, fontWeight: 900, marginTop: 6 }}>{monthLogs.length}</div>
                </div>
              </div>
            </div>
          </div>
...
const STORAGE_KEY = "gardslattur-part3-logs";
const DAY_HISTORY_KEY = "gardslattur-part3-day-history";
...
export default function App() {
  ...
  const bestDay = useMemo(() => {
    ...
    logs.forEach((log) => {
      if (!grouped[log.date]) {
        grouped[log.date] = { date: log.date, earned: 0, minutes: 0, count: 0 };
      }
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gap: 16 }}>
        <div>
          <div style={{ fontSize: 32, fontWeight: 900 }}>Garðsláttur</div>
          <div style={{ color: "#64748b", marginTop: 4 }}>Part 3 af 5</div>
        </div>
        ...
        {screen === "Tölur" && (
          <div style={{ display: "grid", gap: 16 }}>
            ...
            >
              ...
              <div style={cardStyle()}>
                <div style={{ color: "#64748b", fontSize: 13 }}>Meðaltal per verk</div>
                <div style={{ fontSize: 22, fontWeight: 900, marginTop: 6 }}>
                          ...
                          {month.weeks.map((week) => {
                            ...
                            return (
                              ...
                              >
                                <button
                                  onClick={() =>
                                    setExpandedStatsWeek(isWeekOpen ? null : week.weekKey)
                                  }
                                  style={{
                                    width: "100%",
                                    border: "none",
...
const STORAGE_KEY = "gardslattur-part4-logs";
const DAY_HISTORY_KEY = "gardslattur-part4-day-history";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gap: 16 }}>
        <div>
          <div style={{ fontSize: 32, fontWeight: 900 }}>Garðsláttur</div>
          <div style={{ color: "#64748b", marginTop: 4 }}>Part 4 af 5</div>
        </div>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 16,
                        border: selectedDate === cell.dateStr ? "2px solid #2563eb" : "1px solid #dbe2ea",
                        background: dayLogs.length > 0 ? "#dbeafe" : hasTimer ? "#fef3c7" : "#fff",
                        textAlign: "left",
                        padding: 10,
                        cursor: "pointer",
                      }}
        ...
        {screen === "Tölur" && (
          <div style={{ display: "grid", gap: 16 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 12 }}>
              ...
              <div style={cardStyle()}>
                <div style={{ color: "#64748b", fontSize: 13 }}>Mánuður valinn</div>
                <div style={{ fontSize: 22, fontWeight: 900, marginTop: 6 }}>{selectedMonth}</div>
                <div style={{ marginTop: 4 }}>
                  {kr(monthEarned)} • {minsToText(monthMinutes)}
                </div>
              </div>
            </div>
